...
static int lua_fairygui_GBasicTextField_setUnderlineColor(lua_State* tolua_S)
{
	...
	if (argc == 1) {
		...
		tolua_error(tolua_S, "fairygui.GBasicTextField:setUnderlineColor not implemented", nullptr);
		return 0;
	}
...
static int lua_fairygui_InputProcessor_mouseMove(lua_State* tolua_S)
{
	...
	if (argc == 2) {
		...
		tolua_error(tolua_S, "fairygui.InputProcessor:mouseMove not implemented", nullptr);
        return 0;
	}
...
static int lua_register_fairygui_Constants(lua_State* tolua_S)
{
    ...
    tolua_constant(tolua_S, "Linear", static_cast<int>(fairygui::EaseType::Linear));
    tolua_constant(tolua_S, "SineIn", static_cast<int>(fairygui::EaseType::SineIn));
    tolua_constant(tolua_S, "SineOut", static_cast<int>(fairygui::EaseType::SineOut));
    tolua_constant(tolua_S, "SineInOut", static_cast<int>(fairygui::EaseType::SineInOut));
    tolua_constant(tolua_S, "QuadIn", static_cast<int>(fairygui::EaseType::QuadIn));
    tolua_constant(tolua_S, "QuadOut", static_cast<int>(fairygui::EaseType::QuadOut));
    tolua_constant(tolua_S, "QuadInOut", static_cast<int>(fairygui::EaseType::QuadInOut));
    tolua_constant(tolua_S, "CubicIn", static_cast<int>(fairygui::EaseType::CubicIn));
    tolua_constant(tolua_S, "CubicOut", static_cast<int>(fairygui::EaseType::CubicOut));
    tolua_constant(tolua_S, "CubicInOut", static_cast<int>(fairygui::EaseType::CubicInOut));
    tolua_constant(tolua_S, "QuartIn", static_cast<int>(fairygui::EaseType::QuartIn));
    tolua_constant(tolua_S, "QuartOut", static_cast<int>(fairygui::EaseType::QuartOut));
    tolua_constant(tolua_S, "QuartInOut", static_cast<int>(fairygui::EaseType::QuartInOut));
    tolua_constant(tolua_S, "QuintIn", static_cast<int>(fairygui::EaseType::QuintIn));
    tolua_constant(tolua_S, "QuintOut", static_cast<int>(fairygui::EaseType::QuintOut));
    tolua_constant(tolua_S, "QuintInOut", static_cast<int>(fairygui::EaseType::QuintInOut));
    tolua_constant(tolua_S, "ExpoIn", static_cast<int>(fairygui::EaseType::ExpoIn));
    tolua_constant(tolua_S, "ExpoOut", static_cast<int>(fairygui::EaseType::ExpoOut));
    tolua_constant(tolua_S, "ExpoInOut", static_cast<int>(fairygui::EaseType::ExpoInOut));
    tolua_constant(tolua_S, "CircIn", static_cast<int>(fairygui::EaseType::CircIn));
    tolua_constant(tolua_S, "CircOut", static_cast<int>(fairygui::EaseType::CircOut));
    tolua_constant(tolua_S, "CircInOut", static_cast<int>(fairygui::EaseType::CircInOut));
    tolua_constant(tolua_S, "ElasticIn", static_cast<int>(fairygui::EaseType::ElasticIn));
    tolua_constant(tolua_S, "ElasticOut", static_cast<int>(fairygui::EaseType::ElasticOut));
    tolua_constant(tolua_S, "ElasticInOut", static_cast<int>(fairygui::EaseType::ElasticInOut));
    tolua_constant(tolua_S, "BackIn", static_cast<int>(fairygui::EaseType::BackIn));
    tolua_constant(tolua_S, "BackOut", static_cast<int>(fairygui::EaseType::BackOut));
    tolua_constant(tolua_S, "BackInOut", static_cast<int>(fairygui::EaseType::BackInOut));
    tolua_constant(tolua_S, "BounceIn", static_cast<int>(fairygui::EaseType::BounceIn));
    tolua_constant(tolua_S, "BounceOut", static_cast<int>(fairygui::EaseType::BounceOut));
    tolua_constant(tolua_S, "BounceInOut", static_cast<int>(fairygui::EaseType::BounceInOut));
    tolua_constant(tolua_S, "Custom", static_cast<int>(fairygui::EaseType::Custom));
    tolua_endmodule(tolua_S);

    tolua_module(tolua_S,"TweenPropType", 0);
    tolua_beginmodule(tolua_S,"TweenPropType");
    tolua_constant(tolua_S, "None", static_cast<int>(fairygui::TweenPropType::None));
    tolua_constant(tolua_S, "X", static_cast<int>(fairygui::TweenPropType::X));
    tolua_constant(tolua_S, "Y", static_cast<int>(fairygui::TweenPropType::Y));
    tolua_constant(tolua_S, "Position", static_cast<int>(fairygui::TweenPropType::Position));
    tolua_constant(tolua_S, "Width", static_cast<int>(fairygui::TweenPropType::Width));
    tolua_constant(tolua_S, "Height", static_cast<int>(fairygui::TweenPropType::Height));
    tolua_constant(tolua_S, "Size", static_cast<int>(fairygui::TweenPropType::Size));
    tolua_constant(tolua_S, "ScaleX", static_cast<int>(fairygui::TweenPropType::ScaleX));
    tolua_constant(tolua_S, "ScaleY", static_cast<int>(fairygui::TweenPropType::ScaleY));
    tolua_constant(tolua_S, "Scale", static_cast<int>(fairygui::TweenPropType::Scale));
    tolua_constant(tolua_S, "Rotation", static_cast<int>(fairygui::TweenPropType::Rotation));
    tolua_constant(tolua_S, "Alpha", static_cast<int>(fairygui::TweenPropType::Alpha));
    tolua_constant(tolua_S, "Progress", static_cast<int>(fairygui::TweenPropType::Progress));
    tolua_endmodule(tolua_S);
    return 1;
}
